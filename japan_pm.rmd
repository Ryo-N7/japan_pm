...
ggplot(economics) +
  ...
  ggtitle("United States Unemployment (1967-2015)") +
  labs(y = "Number of Unemployed (in thousands)")
...
```{r first-plot, fig.height=6, fig.width=8, fig.align='center', warning=FALSE}
...
```{r plot-again, fig.height=6, fig.width=8, fig.align='center'}
# second try!
